...
} from "../request/reporteChequeo";

function ConsultaReporteChequeo(
    onOk: Function,
    parametrosBusqueda?: {
        limit?: number,
        offset?: number,
...
function RegistrarReporteChequeo(
...
function ModificarReporteChequeo(
    idRegistro: number,
    formRegistro: FormData,
    onOk?: Function,
    onError?: Function,
...
function RemoverReporteChequeo(
    idRegistro: number,
    onOk?: Function,
    onError?: Function,
    onAntes?: Function,
